...
class ShoppingCart(BasePage):
    ...
    SHOPPING_CART_PRODUCT_BRAND_NAME = (By.CSS_SELECTOR, ".brand-name-md ._heading-strong")
    SHOPPING_CART_PRODUCT_NAME = (By.CSS_SELECTOR, "[class='text-link name']")
    SHOPPING_CART_PRODUCT_SIZE = (By.XPATH, "//li[1]/span[@class='value-label']")
    SHOPPING_CART_PRODUCT_COLOUR = (By.XPATH, "//li[2]/span[@class='value-label']")
    SHOPPING_CART_PRODUCT_QUANTITY_AND_PRICE = (By.XPATH, "//li[2]/span[@class='value-label']")
    SHOPPING_CART_PRODUCT_PRICE = (By.CSS_SELECTOR, ".item-price-md.price']")
    SHOPPING_CART_SUMMARY_PRICE = (By.CSS_SELECTOR, ".summary-block .summary-row:nth-of-type(1) .price")
    SHOPPING_CART_TOTAL_PRICE_WITH_TAX = (By.CSS_SELECTOR, ".total .price")
    SHOPPING_CART_PROCEED_TO_PAYMENT_BUTTON = (By.CSS_SELECTOR, "[data-test-id='cart-proceed-to-checkout']")
    ...
    def get_returned_item_from_shopping_cart_by_product_name(self, product_brand: str, product_name: str) -> WebElement:
        """
        ...
        long_product_name = product_brand.capitalize() + ' ' + product_name
        item = (By.XPATH, f"//div[@class='brand-name brand-name-md']/a[@title='{long_product_name}']/ancestor::div[@class='item-block-container']")
        shopping_cart_item = self.find(item)
        return shopping_cart_item

    @allure.step("Get text of product brand name in shopping cart")
    def get_text_of_product_brand_name_in_shopping_cart(self, product_brand: str, product_name: str) -> str:
        """
        ...
        """
        shopping_cart_item = self.get_returned_item_from_shopping_cart_by_product_name(product_brand, product_name)
        return shopping_cart_item.find_element(*self.SHOPPING_CART_PRODUCT_BRAND_NAME).text

    @allure.step("Get text of product name in shopping cart")
    def get_text_of_product_name_in_shopping_cart(self, product_brand: str, product_name: str) -> str:
        """
    ...
    def get_text_of_product_colour_in_shopping_cart(self, product_brand: str, product_name: str) -> str:
        """
    ...
    def get_text_of_product_size_in_shopping_cart(self, product_brand: str, product_name: str) -> str:
        """
    ...
    def get_text_of_product_quantity_and__price_in_shopping_cart(self, product_brand: str, product_name: str) -> str:
        """
        ...
        """
        shopping_cart_item = self.get_returned_item_from_shopping_cart_by_product_name(product_brand, product_name)
        return shopping_cart_item.find_element(*self.SHOPPING_CART_PRODUCT_QUANTITY_AND_PRICE).text

    @allure.step("Get text of product price in shopping cart")
    def get_text_of_product_price_in_shopping_cart(self, product_brand: str, product_name: str) -> str:
        """
