...
class ModalAddedToCardConfirmation(BasePage):
    ...
    GO_TO_CARD_BUTTON = (By.CSS_SELECTOR, "[data-test-id='added-to-cart-go-to-cart-button']")

    MODAL_ADDED_TO_CART_BRAND_NAME = (By.CSS_SELECTOR, "[class='text-link brand']")
    MODAL_ADDED_TO_CART_NAME = (By.CSS_SELECTOR, "[class='text-link name nuxt-link-exact-active nuxt-link-active']")
    MODAL_ADDED_TO_CART_DISCOUNT_PRICE = (By.CSS_SELECTOR, ".extra-small .price-with-discount .price")
    MODAL_ADDED_TO_CART_DISCOUNT = (By.CSS_SELECTOR, ".extra-small .discount-text")
    MODAL_ADDED_TO_CART_FINAL_PRICE = (By.CSS_SELECTOR, ".extra-small .final-price-wrapper .price")
